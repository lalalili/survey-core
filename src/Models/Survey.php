...
class Survey extends Model
{
    ...
    /**
     * Typed accessor for settings_json.  Use this for new code — avoids
     * bare data_get() strings scattered across the codebase.
     */
    public function settings(): SurveySettings
    {
        return SurveySettings::fromArray($this->settings_json ?? []);
    }
